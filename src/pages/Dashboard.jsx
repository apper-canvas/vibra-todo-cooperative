      ...
      <section>
        ...
        >
          <h1 className="font-bold text-2xl md:text-3xl lg:text-4xl mb-2 bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent">
            Welcome, {user.firstName || 'Task Manager'}
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {/* Stats Cards */}
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }} className="neu-card p-4 flex items-center">
            ...
            <div>
              ...
              <p className="text-xl font-semibold">{stats.isLoading ? '...' : stats.completedTasks}</p>
            </div>
          </motion.div>
          
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} className="neu-card p-4 flex items-center">
            ...
            <div>
              ...
              <p className="text-xl font-semibold">{stats.isLoading ? '...' : stats.totalTasks}</p>
            </div>
          </motion.div>
          
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.3 }} className="neu-card p-4 flex items-center">
            ...
            <div>
              ...
              <p className="text-xl font-semibold">{stats.isLoading ? '...' : stats.dueToday}</p>
            </div>
          </motion.div>
          
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.4 }} className="neu-card p-4 flex items-center">
            ...
            <div>
              ...
              <p className="text-xl font-semibold">{stats.isLoading ? '...' : `${stats.progress}%`}</p>
            </div>
          </motion.div>
        </div>
        ...
        >
          <TaskList onTasksChange={updateStats} />
        </motion.div>
      </section>
    </div>
  );
